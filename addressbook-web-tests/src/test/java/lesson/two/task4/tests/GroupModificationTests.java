...
public class GroupModificationTests extends TestBase {
    ...
    public void testGroupModification() {
        ...
        GroupData group = new GroupData().withId(modifiedGroup.getId()).withName("Modified group name").withHeader("some header from recorder (test existing)").withFooter("Modified group footer");
        app.goTo().groupPage();
